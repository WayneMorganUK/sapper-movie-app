        ...
        <div class='single-column'>
          <div class='detail-inner'>
            ...
            <div class='movie-data'>
              <div class='title'>
                <h2 class='movie-title'>{movie_details.name} <span class='release_date'>
                  {movie_details.first_air_date ? (movie_details.first_air_date.substring(0,4)) : ''}
                </span></h2>
                <div class='facts'>
                  <div class='date'>{movie_details.first_air_date ? movie_details.first_air_date: 'No Date Available'}</div>
                  <div class='genres'>
